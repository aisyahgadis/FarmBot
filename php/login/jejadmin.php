...
if (isset($_GET['id'])) {
    ...
    if (!empty($nama_hama) && !empty($jenis_tips) && !empty($penangakl)) {
        ...
        if (mysqli_query($conn, $sql)) {
            echo "<script>alert('Data berhasil diperbarui!'); window.location.href='../database/jadmin.php';</script>";
        } else {
    ...
    $sql = "SELECT * FROM jaga WHERE id = '$id'";
...
<body>
    <div class="wrapper">
        <form method="post">
            ...
            <p>Tidak ada yang perlu diperbarui?<a href="../database/jadmin.php">Kembali</a></p>
</body>
</html>