...
<body>
        <section class home>
            <div class="navbar">
                ...
                <ul>
                    <li><a href="tadmin.php#content">Home</a></li>
                    <li>
                        <a href="#">About</a>
                        <ul class="dropdown">
                            <li><a href="tadmin.php#about-web">About web</a></li>
                            <li><a href="tadmin.php#about-me">About me</a></li>
                            <li><a href="tadmin.php#visi-misi">VisiMisi</a></li>
                        </ul>
                    </li>
                    <li><a href="produktivitas.php">Produktivitas</a></li>
                    <li><a href="#perawatan">Perawatan</a></li>
                    <li><a href="jagaadmin.php">Penjagaan</a></li>
                    <li><a href="tadmin.php#informasi">Informasi</a></li>
                    <li><a href="tadmin.php#data">Data</a></li>
                </ul>
            </div>
        </section> 
    ...
    if (isset($_POST['simpan'])) {
        ...
        $insert = "INSERT INTO rawat (nama_tanaman, cara_perawatan) 
    ...
    <section>
        <div id="perawatan" >
            <h2>Simulasi Budidaya Tanaman</h2>
                <form action="./rawatadmin.php" method="post">
                    <label>Nama Tanaman:</label><br>
                    <input type="text" name="nama_tanaman" value="<?= htmlspecialchars($nama_tanaman) ?>" required><br><br>
                    <label>Cara Perawatan:</label><br>
                    <textarea name="cara_perawatan" rows="6" cols="50" class="input-deskripsi"><?= htmlspecialchars($cara_perawatan) ?></textarea><br><br>
                    <div class="button-row">
                        <a href="rawat.php"><button type="button"><span></span>Refresh</a></button>
