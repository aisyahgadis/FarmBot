...
<body>
    ...
    $penangkal = '';
     if (isset($_POST['simpan'])) {
        ...
        $insert = "INSERT INTO jaga (nama_hama, jenis_tips, penangkal) 
    ...
    <section>
        <div id="penjagaan" >
            <h2>Simulasi Budidaya Tanaman</h2>
                <form  action="./jagaadmin.php" method="POST">
                    <label>Hama:</label><br>
                    ...
                    <label>Penangkal:</label><br>
                     <textarea name="penangkal" rows="6" cols="50" class="input-deskripsi"><?= htmlspecialchars($penangkal) ?></textarea><br><br>
                    <div class="button-row">
                        <a href="jagaadmin.php"><button type="button"><span></span>Refresh</a></button>
